...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g5825a46ccf/BNBFaceTracker.zip",
            checksum: "86fe915d1dac8acf52c495b315abd896b1a170d0b44daba1549f15a4327dfd1c"
        ),
        .target(
