...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-61-g2b7f7b2a6c/BNBFaceTracker.zip",
            checksum: "7c50a4398cc06bed877130b81dc891492e55f72614d738b54970719f734da5fd"
        ),
        .target(
