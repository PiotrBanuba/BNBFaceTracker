...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g6aa1953f1a/BNBFaceTracker.zip",
            checksum: "94a432737c8237d6967af1fd0e62b04d2e1db89c6bd2e67799d99ac67ea999fc"
        ),
        .target(
