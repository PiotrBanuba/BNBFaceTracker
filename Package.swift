...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-62-g077d3df291/BNBFaceTracker.zip",
            checksum: "d581df27bee248a041ac962055c8daa2c21a4defb5668a40f72e12bddc50f8b1"
        ),
        .target(
