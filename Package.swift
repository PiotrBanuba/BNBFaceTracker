...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-64-g951557ebd1/BNBFaceTracker.zip",
            checksum: "8b22d395c93352a1e1a63291a4af5952d5983ca3dd23b609459632ed17858fc7"
        ),
        .target(
