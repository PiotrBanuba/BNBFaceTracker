...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceTracker",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.9.1-83-gf89cbbd807/BNBFaceTracker.zip",
            checksum: "d11170384fd92e8b0ef08edbdd95f2f3a2688f63df130120aa508977747202c4"
        ),
        .target(
